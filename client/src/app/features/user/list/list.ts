...
import { CreateUpdateTask } from '../create-update-user/create-update-user';
...
export class UserList {
  ...
  public columns: ListColumn[] = [
    { key: 'title', label: 'Name', sortable: true, type: 'text', truncateLength: 0 },
    { key: 'description', label: 'Email', sortable: false, type: 'truncate', truncateLength: 15 },
    { key: 'status', label: 'Role', sortable: false, type: 'status-badge', truncateLength: 0 },
